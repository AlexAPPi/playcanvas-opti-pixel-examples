export class FlyCamera extends pc.ScriptType {
    ...
    public update(dt: number) {
        ...
        const app = this.app;
        const touchPad = (window as any).touchJoypad;
        ...
        // Joypad control
        const joystickMover = touchPad?.sticks['joystick0'];
        const joystickRoter = touchPad?.sticks['joystick1'];
        
        if (this.mobileControls && touchPad?.buttons.wasPressed('button2')) {
...
export const flyCameraScriptName = 'OptiPixel:FlyCameraScript';
